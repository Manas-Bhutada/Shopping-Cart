...
const CartItem = ({item}) => {
  ...
  return (
    <div className="p-4 border-b-2 last:border-none border-slate-700 m-7 rounded-xl
    bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-rose-100 to-teal-100">
