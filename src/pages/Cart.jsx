...
const Cart = () => {
  ...
  return (
    <div className="min-h-[700px] bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))]  from-teal-300 to-pink-300">
  {
    cart.length > 0  ? 
    
    (<div className="w-screen flex gap-16 max-w-6xl p-6 mx-auto flex-wrap lg:flex-nowrap">
    ...
    (<div className="min-h-[810px] flex flex-col gap-6 justify-center items-center">
